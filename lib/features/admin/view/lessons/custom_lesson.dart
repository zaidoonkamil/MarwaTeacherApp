...
class CustomLesson extends StatelessWidget {
  const CustomLesson({super.key, required this.courseId});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => AdminCubit()..getLessons(context: context, courseId: courseId,),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text('اضافة محاضرة',textAlign: TextAlign.center,style: TextStyle(color: Colors.white),),
                          ),
                        ),
                        SizedBox(height: 26,),
                        Expanded(
